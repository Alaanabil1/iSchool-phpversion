(function($) {
    ...
    if (page.includes("free")) {
        $(".main-nav .nav-item").removeClass("active");
        $("#freesessionbutton").attr("class", "btn btn-warning");
    } else if (page.includes("register")) {
        $(".main-nav .nav-item").removeClass("active");
        $('a[href="registerstep01.php"]').parents("li").addClass("active");
    } else if (page.includes("contact")) {
        $(".main-nav .nav-item").removeClass("active");
        $('a[href="contactus.php"]').parents("li").addClass("active");
    } else if (page === "" || page.includes("index")) {
        $(".main-nav .nav-item").removeClass("active");
        $('a[href="/#home"]').parents("li").addClass("active");
            ...
            if (window.innerWidth >= 750) {
                ...
                $(".wrapper-programs").each(function() {
                    if ($(this).attr("data-clicked") === "true ") {
                        ...
                        setTimeout(function() {
                            $(
                                ".wrapper-programs:nth-child(" + (index1 + 1) + ")"
                            ).removeClass("rightpos");
                        }, 1000);
                    }
                });
                    ...
                    if ($(this).attr("data-clicked") === "true " && check_index != 8) {
                        ...
                        const runTimer02 = () => {
                            timer02 = window.setTimeout(function() {
                                $(".wrapper-programs").removeClass("expanded");
                                $(".wrapper-programs:nth-child(" + (ind - 1) + ")").addClass(
                                    "rightpos"
                                );
                                setTimeout(function() {
                                    $(
                                        ".wrapper-programs:nth-child(" + (ind - 1) + ")"
                                    ).removeClass("rightpos");
                                }, 1000);
                                $(".wrapper-programs:nth-child(" + ind + ")").addClass(
                                    "expanded"
                                );
                                $(".wrapper-programs:nth-child(" + (ind - 1) + ")").attr(
                                    "data-clicked",
                                    "false "
                                );
                                $(".wrapper-programs:nth-child(" + ind + ")").attr(
                                    "data-clicked",
                                    "true "
                                );
                        ...
                        const runTimer01 = () => {
                            timer01 = window.setTimeout(function() {
                                ...
                                $(".wrapper-programs:nth-child(9)").attr(
                                    "data-clicked",
                                    "false "
                                );
                                $(".wrapper-programs:nth-child(1)").attr(
                                    "data-clicked",
                                    "true "
                                );
        ...
        $(".faq-ques").click(function() {
            ...
            Selectorr = $(this).attr("data-selector");
            $(Selectorr).toggleClass("show");
        });
